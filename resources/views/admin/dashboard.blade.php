        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">{{$jumlah_sekolah}}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Tempat Ibadah</span>
                <span class="info-box-number">{{$jumlah_tempat_ibadah}}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Tempat Perbelanjaan</span>
                <span class="info-box-number">{{$jumlah_tempat_perbelanjaan}}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <div class="col-12">
            <div class="card card-light">
              <div class="card-header">
                <h3 class="card-title">Pemetaan Potensi Desa Tegal Harum</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
