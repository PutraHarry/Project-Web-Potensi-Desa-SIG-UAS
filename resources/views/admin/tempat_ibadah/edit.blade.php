...
@section('content')
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit Data</h3>
                    ...
                    <form action="/tempat-ibadah/update/{{$tempatibadah->id}}" method="POST">  
                    @csrf
                        <div class="card-body">     
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input name="nama" class="form-control" placeholder="Tempat Ibadah" required value="{{$tempatibadah->nama}}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" style="width: 100%;" name="agama" required>
                                            <option value="hindu" @if($tempatibadah->agama == 'Hindu') selected @endif>Hindu</option>
                                            <option value="islam" @if($tempatibadah->agama == 'Islam') selected @endif>Islam</option>
                                            <option value="kristen katolik" @if($tempatibadah->agama == 'Kristen Katolik') selected @endif>Kristen Katolik</option>
                                            <option value="kristen protestan" @if($tempatibadah->agama == 'Kristen Protestan') selected @endif>Kristen Protestan</option>
                                        </select>
                                    </div>
                                </div>  
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input name="alamat" class="form-control" placeholder="Alamat Tempat Ibadah" required value="{{$tempatibadah->alamat}}">
                                    </div>
                                </div>
    ...
    <script>
        ...
        var peta4 = L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw', {
            ...
            var map = L.map('map', {
            center: [tempatibadah.lat, tempatibadah.lng],
            zoom: 15,
            layers: [peta1, desa]
            });
