            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Tambah Data</h3>
                    ...
                    <form action="/pasar/insert" method="POST">  
                    @csrf
                        <div class="card-body">     
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input name="nama" class="form-control" placeholder="Pasar" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Alamat Pasar</label>
                                        <input name="alamat" class="form-control" placeholder="Alamat Pasar" required>
                                    </div>
                                </div>
